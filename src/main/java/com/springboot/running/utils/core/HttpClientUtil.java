...
public class HttpClientUtil {
	 ...
	 * @return
	 */
	public static String getWithHead(String url, List<NameValuePair> params,int timeout,boolean httpsCerVerify,Map<String,String> headMap) throws Exception {
...
//			status = post(uri, paramList,timeout);
	 ...
	 * @return
	 */
	public static String requestWithParamAndHeader(String url, int type,int timeout,boolean httpsCerVerify,Map<String,String> headMap) throws Exception{
		//拆开参数
		List<NameValuePair> paramList = new ArrayList<NameValuePair>();
		int i = url.indexOf("?");
		String uri,body;
		...
		if(type == 0){
			body = getWithHead(uri, paramList,timeout,httpsCerVerify,headMap);
			
		}else{
			//body = postWithHead(uri, paramList,timeout,httpsCerVerify,headMap);
			return "";
		}
		return body;
	}
	 ...
	 * @return
	 */
	private static List<NameValuePair> splitParam(String paramStr){
